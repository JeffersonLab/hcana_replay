...
// Fri Nov 21 19:40:11 2014 by ROOT version 5.34/06
// from TTree h9010/
// found on file: paw/hms52949_rz.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("paw/hms52949_rz.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("paw/hms52949_rz.root");
      }
