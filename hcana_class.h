...
// Fri Nov 21 19:35:50 2014 by ROOT version 5.34/06
// from TTree T/Hall A Analyzer Output DST
// found on file: Rootfiles/hodtest_52949.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Rootfiles/hodtest_52949.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Rootfiles/hodtest_52949.root");
      }
      f->GetObject("T",tree);
