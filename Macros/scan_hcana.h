...
// Tue Sep  3 18:06:06 2013 by ROOT version 5.34/01
// from TTree T/Hall A Analyzer Output DST
// found on file: compare_dc_52949.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Double_t        H_dc_1u1_dist[20];   //[Ndata.H.dc.1u1.dist]
   Int_t           Ndata_H_dc_1u1_rawtdc;
   Double_t        H_dc_1u1_rawtdc[20];   //[Ndata.H.dc.1u1.rawtdc]
   Int_t           Ndata_H_dc_1u1_tdchits;
   Double_t        H_dc_1u1_tdchits[20];   //[Ndata.H.dc.1u1.tdchits]
   Int_t           Ndata_H_dc_1u1_time;
   Double_t        H_dc_1u1_time[20];   //[Ndata.H.dc.1u1.time]
   Int_t           Ndata_H_dc_1v1_dist;
   Double_t        H_dc_1v1_dist[36];   //[Ndata.H.dc.1v1.dist]
   Int_t           Ndata_H_dc_1v1_rawtdc;
   Double_t        H_dc_1v1_rawtdc[36];   //[Ndata.H.dc.1v1.rawtdc]
   Int_t           Ndata_H_dc_1v1_tdchits;
   Double_t        H_dc_1v1_tdchits[36];   //[Ndata.H.dc.1v1.tdchits]
   Int_t           Ndata_H_dc_1v1_time;
   Double_t        H_dc_1v1_time[36];   //[Ndata.H.dc.1v1.time]
   ...
   Double_t        H_dc_1x2_dist[20];   //[Ndata.H.dc.1x2.dist]
   Int_t           Ndata_H_dc_1x2_rawtdc;
   Double_t        H_dc_1x2_rawtdc[20];   //[Ndata.H.dc.1x2.rawtdc]
   Int_t           Ndata_H_dc_1x2_tdchits;
   Double_t        H_dc_1x2_tdchits[20];   //[Ndata.H.dc.1x2.tdchits]
   Int_t           Ndata_H_dc_1x2_time;
   Double_t        H_dc_1x2_time[20];   //[Ndata.H.dc.1x2.time]
   Int_t           Ndata_H_dc_1y1_dist;
   Double_t        H_dc_1y1_dist[17];   //[Ndata.H.dc.1y1.dist]
   Int_t           Ndata_H_dc_1y1_rawtdc;
   Double_t        H_dc_1y1_rawtdc[17];   //[Ndata.H.dc.1y1.rawtdc]
   Int_t           Ndata_H_dc_1y1_tdchits;
   Double_t        H_dc_1y1_tdchits[17];   //[Ndata.H.dc.1y1.tdchits]
   Int_t           Ndata_H_dc_1y1_time;
   Double_t        H_dc_1y1_time[17];   //[Ndata.H.dc.1y1.time]
   Int_t           Ndata_H_dc_1y2_dist;
   Double_t        H_dc_1y2_dist[11];   //[Ndata.H.dc.1y2.dist]
   Int_t           Ndata_H_dc_1y2_rawtdc;
   Double_t        H_dc_1y2_rawtdc[11];   //[Ndata.H.dc.1y2.rawtdc]
   Int_t           Ndata_H_dc_1y2_tdchits;
   Double_t        H_dc_1y2_tdchits[11];   //[Ndata.H.dc.1y2.tdchits]
   Int_t           Ndata_H_dc_1y2_time;
   Double_t        H_dc_1y2_time[11];   //[Ndata.H.dc.1y2.time]
   Int_t           Ndata_H_dc_2u1_dist;
   Double_t        H_dc_2u1_dist[13];   //[Ndata.H.dc.2u1.dist]
   Int_t           Ndata_H_dc_2u1_rawtdc;
   Double_t        H_dc_2u1_rawtdc[13];   //[Ndata.H.dc.2u1.rawtdc]
   Int_t           Ndata_H_dc_2u1_tdchits;
   Double_t        H_dc_2u1_tdchits[13];   //[Ndata.H.dc.2u1.tdchits]
   Int_t           Ndata_H_dc_2u1_time;
   Double_t        H_dc_2u1_time[13];   //[Ndata.H.dc.2u1.time]
   Int_t           Ndata_H_dc_2v1_dist;
   Double_t        H_dc_2v1_dist[69];   //[Ndata.H.dc.2v1.dist]
   Int_t           Ndata_H_dc_2v1_rawtdc;
   Double_t        H_dc_2v1_rawtdc[69];   //[Ndata.H.dc.2v1.rawtdc]
   Int_t           Ndata_H_dc_2v1_tdchits;
   Double_t        H_dc_2v1_tdchits[69];   //[Ndata.H.dc.2v1.tdchits]
   Int_t           Ndata_H_dc_2v1_time;
   Double_t        H_dc_2v1_time[69];   //[Ndata.H.dc.2v1.time]
   Int_t           Ndata_H_dc_2x1_dist;
   Double_t        H_dc_2x1_dist[35];   //[Ndata.H.dc.2x1.dist]
   Int_t           Ndata_H_dc_2x1_rawtdc;
   Double_t        H_dc_2x1_rawtdc[35];   //[Ndata.H.dc.2x1.rawtdc]
   Int_t           Ndata_H_dc_2x1_tdchits;
   Double_t        H_dc_2x1_tdchits[35];   //[Ndata.H.dc.2x1.tdchits]
   Int_t           Ndata_H_dc_2x1_time;
   Double_t        H_dc_2x1_time[35];   //[Ndata.H.dc.2x1.time]
   Int_t           Ndata_H_dc_2x2_dist;
   Double_t        H_dc_2x2_dist[13];   //[Ndata.H.dc.2x2.dist]
   Int_t           Ndata_H_dc_2x2_rawtdc;
   Double_t        H_dc_2x2_rawtdc[13];   //[Ndata.H.dc.2x2.rawtdc]
   Int_t           Ndata_H_dc_2x2_tdchits;
   Double_t        H_dc_2x2_tdchits[13];   //[Ndata.H.dc.2x2.tdchits]
   Int_t           Ndata_H_dc_2x2_time;
   Double_t        H_dc_2x2_time[13];   //[Ndata.H.dc.2x2.time]
   Int_t           Ndata_H_dc_2y1_dist;
   Double_t        H_dc_2y1_dist[19];   //[Ndata.H.dc.2y1.dist]
   Int_t           Ndata_H_dc_2y1_rawtdc;
   Double_t        H_dc_2y1_rawtdc[19];   //[Ndata.H.dc.2y1.rawtdc]
   Int_t           Ndata_H_dc_2y1_tdchits;
   Double_t        H_dc_2y1_tdchits[19];   //[Ndata.H.dc.2y1.tdchits]
   Int_t           Ndata_H_dc_2y1_time;
   Double_t        H_dc_2y1_time[19];   //[Ndata.H.dc.2y1.time]
   Int_t           Ndata_H_dc_2y2_dist;
   Double_t        H_dc_2y2_dist[12];   //[Ndata.H.dc.2y2.dist]
   Int_t           Ndata_H_dc_2y2_rawtdc;
   Double_t        H_dc_2y2_rawtdc[12];   //[Ndata.H.dc.2y2.rawtdc]
   Int_t           Ndata_H_dc_2y2_tdchits;
   Double_t        H_dc_2y2_tdchits[12];   //[Ndata.H.dc.2y2.tdchits]
   Int_t           Ndata_H_dc_2y2_time;
   Double_t        H_dc_2y2_time[12];   //[Ndata.H.dc.2y2.time]
   Int_t           Ndata_H_dc_residual;
   Double_t        H_dc_residual[12];   //[Ndata.H.dc.residual]
   Int_t           Ndata_H_dc_x;
   Double_t        H_dc_x[50];   //[Ndata.H.dc.x]
   Int_t           Ndata_H_dc_xp;
   Double_t        H_dc_xp[50];   //[Ndata.H.dc.xp]
   Int_t           Ndata_H_dc_y;
   Double_t        H_dc_y[50];   //[Ndata.H.dc.y]
   Int_t           Ndata_H_dc_yp;
   Double_t        H_dc_yp[50];   //[Ndata.H.dc.yp]
   Int_t           Ndata_H_tr_beta;
   Double_t        H_tr_beta[48];   //[Ndata.H.tr.beta]
   Int_t           Ndata_H_tr_chi2;
   Double_t        H_tr_chi2[48];   //[Ndata.H.tr.chi2]
   Int_t           Ndata_H_tr_d_ph;
   Double_t        H_tr_d_ph[48];   //[Ndata.H.tr.d_ph]
   Int_t           Ndata_H_tr_d_th;
   Double_t        H_tr_d_th[48];   //[Ndata.H.tr.d_th]
   Int_t           Ndata_H_tr_d_x;
   Double_t        H_tr_d_x[48];   //[Ndata.H.tr.d_x]
   Int_t           Ndata_H_tr_d_y;
   Double_t        H_tr_d_y[48];   //[Ndata.H.tr.d_y]
   Int_t           Ndata_H_tr_dbeta;
   Double_t        H_tr_dbeta[48];   //[Ndata.H.tr.dbeta]
   Int_t           Ndata_H_tr_dtime;
   Double_t        H_tr_dtime[48];   //[Ndata.H.tr.dtime]
   Int_t           Ndata_H_tr_flag;
   Double_t        H_tr_flag[48];   //[Ndata.H.tr.flag]
   Int_t           Ndata_H_tr_ndof;
   Double_t        H_tr_ndof[48];   //[Ndata.H.tr.ndof]
   Int_t           Ndata_H_tr_p;
   Double_t        H_tr_p[48];   //[Ndata.H.tr.p]
   Int_t           Ndata_H_tr_pathl;
   Double_t        H_tr_pathl[48];   //[Ndata.H.tr.pathl]
   Int_t           Ndata_H_tr_ph;
   Double_t        H_tr_ph[48];   //[Ndata.H.tr.ph]
   Int_t           Ndata_H_tr_px;
   Double_t        H_tr_px[48];   //[Ndata.H.tr.px]
   Int_t           Ndata_H_tr_py;
   Double_t        H_tr_py[48];   //[Ndata.H.tr.py]
   Int_t           Ndata_H_tr_pz;
   Double_t        H_tr_pz[48];   //[Ndata.H.tr.pz]
   Int_t           Ndata_H_tr_r_ph;
   Double_t        H_tr_r_ph[48];   //[Ndata.H.tr.r_ph]
   Int_t           Ndata_H_tr_r_th;
   Double_t        H_tr_r_th[48];   //[Ndata.H.tr.r_th]
   Int_t           Ndata_H_tr_r_x;
   Double_t        H_tr_r_x[48];   //[Ndata.H.tr.r_x]
   Int_t           Ndata_H_tr_r_y;
   Double_t        H_tr_r_y[48];   //[Ndata.H.tr.r_y]
   Int_t           Ndata_H_tr_tg_dp;
   Double_t        H_tr_tg_dp[48];   //[Ndata.H.tr.tg_dp]
   Int_t           Ndata_H_tr_tg_ph;
   Double_t        H_tr_tg_ph[48];   //[Ndata.H.tr.tg_ph]
   Int_t           Ndata_H_tr_tg_th;
   Double_t        H_tr_tg_th[48];   //[Ndata.H.tr.tg_th]
   Int_t           Ndata_H_tr_tg_y;
   Double_t        H_tr_tg_y[48];   //[Ndata.H.tr.tg_y]
   Int_t           Ndata_H_tr_th;
   Double_t        H_tr_th[48];   //[Ndata.H.tr.th]
   Int_t           Ndata_H_tr_time;
   Double_t        H_tr_time[48];   //[Ndata.H.tr.time]
   Int_t           Ndata_H_tr_vx;
   Double_t        H_tr_vx[48];   //[Ndata.H.tr.vx]
   Int_t           Ndata_H_tr_vy;
   Double_t        H_tr_vy[48];   //[Ndata.H.tr.vy]
   Int_t           Ndata_H_tr_vz;
   Double_t        H_tr_vz[48];   //[Ndata.H.tr.vz]
   Int_t           Ndata_H_tr_x;
   Double_t        H_tr_x[48];   //[Ndata.H.tr.x]
   Int_t           Ndata_H_tr_y;
   Double_t        H_tr_y[48];   //[Ndata.H.tr.y]
   Double_t        H_dc_nhit;
 ...
 //THaEvent        *Event_Branch;
   ...
   scan_hcana(TString ifile,TTree *tree=0);
   virtual ~scan_hcana();
...
#ifdef scan_hcana_cxx
scan_hcana::scan_hcana(TString ifile,TTree *tree) : fChain(0) 
{
...
scan_hcana::~scan_hcana()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t scan_hcana::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t scan_hcana::LoadTree(Long64_t entry)
{
...
void scan_hcana::Init(TTree *tree)
{
...
void scan_hcana::Show(Long64_t entry)
{
...
void scan_hcana::PrintTrack(Long64_t entry)
{
// Print contents of entry.
// If entry is not specified, print current entry
   if (!fChain) return;
