...
TCanvas *ch1adc = new TCanvas("ch1adc","Ch1 Compare ADC hit spectra ",1200,1000);
TCanvas *ch2adc = new TCanvas("ch2adc","Ch2 Compare ADC hit spectra ",1200,1000);
