...
void replay_sos(Int_t RunNumber=52949, Int_t FirstToReplay=1, Int_t MaxEventToReplay=11000) {
 ...
 THaApparatus* SOS = new THcHallCSpectrometer("S","SOS");
  ...
  analyzer->SetOutFile(Form("Rootfiles/replay_sos_%05d.root",RunNumber));
  analyzer->SetOdefFile("output_replay_sos.def");
  analyzer->SetCutFile("cuts_replay_sos.def");        // optional
